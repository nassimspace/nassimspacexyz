...
class GDriveFolderEmbed extends HTMLElement {
  ...
  async connectedCallback() {
    ...
    try {
      ...
      iframe.setAttribute("style", "justify-content: space-evenly; width:60vw; height: 75vh;display: inline-block; background: #180436; position: relative; object-fit: contain; border: none;");
