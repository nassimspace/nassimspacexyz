...
class GDriveFolderEmbed extends HTMLElement {
  ...
  async connectedCallback() {
    ...
    try {
      ...
      iframe.setAttribute("style", "justify-content: space-evenly; width:65dvw; height: 75dvh;display: inline-block; background: #180436; position: relative; object-fit: contain; border: none;");
